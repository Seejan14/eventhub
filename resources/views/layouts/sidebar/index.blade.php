<aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 fixed-start"
  style="z-index: 99" id="sidenav-main">
  <div class="sidenav-header flex">
    {{-- <i class="fas fa-times p-3 cursor-pointer text-secondary opacity-5 position-absolute end-0 top-0 d-none d-xl-none"
      aria-hidden="true" id="iconSidenav"></i> --}}
    <a class=" justify-content-center" href="/">
      <img src="{{ asset('assets/img/logos/eventhublogo.png') }}"  alt="main_logo" class="w-100 h-100 object-contain ">
  ...
  <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main" style="height: auto !important;">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link @if($activePage == 'Bookings') active @endif"
          href="{{ route('bookings') }}">
          <div
            class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
            <i class="ni ni-calendar-grid-58 icon-color text-sm opacity-10"></i>
      ...
      <li class="nav-item">
        <a class="nav-link @if($activePage == 'Events') active @endif" href="{{ route('event.index', ['page' => 1]) }}">
          <div
            class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
            <i class="ni ni-calendar-grid-58 icon-color text-sm opacity-10"></i>
          </div>
      ...
      <li class="nav-item">
        <a class="nav-link @if($activePage == 'contacts') active @endif"
          href="{{ route('contacts') }}">
          <div
            class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
            <i class="ni ni-calendar-grid-58 icon-color text-sm opacity-10"></i>
