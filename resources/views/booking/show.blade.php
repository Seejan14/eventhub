        ...
        <div class="col-md-12">
            <div class="card p-3">
                ...
                <div class="info-data">
                    <div class="row">
                        <div class="col-md-6">
                            <h6><strong>Package:</strong> {{ $booking->package->title }}</h6>
                        </div>
                        <div class="col-md-6">
                            <h6><strong>Schedule:</strong> {{ $booking->schedule->start_date }} to {{$booking->schedule->end_date}}</h6>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <h6><strong>Booking Number:</strong> {{ $booking->booking_number }}</h6>
                        </div>
                        <div class="col-md-6">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            <h6><strong>Name:</strong> {{ $booking->user->name }}</h6>
                        </div>
                        <div class="col-md-6">
                            <h6><strong>Email:</strong> {{ $booking->user->email }}</h6>
                        </div>
                        <div class="col-md-6">
                            <h6><strong>Phone Number:</strong> {{ $booking->user->phone }}</h6>
                        </div>
                        <div class="col-md-6">
...
<script>
    $(document).ready(function() {
        ...
        $('.change').click(function() {
            ...
            $('#modal-text').html(`This will ${status === 'cancel' ? 'cancel' : 'approve'} the booking.`);
        });
